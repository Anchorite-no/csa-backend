...
def update_recruit_deadline(new_deadline_str: str):
    """Compatibility entry point; dynamic settings live in the database."""
    from models import SessionLocal
    from misc.recruit_deadline import set_recruit_deadline

    with SessionLocal() as db:
        return set_recruit_deadline(db, new_deadline_str)
